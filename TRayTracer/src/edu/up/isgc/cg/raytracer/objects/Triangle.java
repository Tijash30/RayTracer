 ...
 */
/*This class is just to check the triangles of an object, it  checks them by pssing the position of each triangle of an object, by 3 differente
* vectors, this will have the exact position.*/
public class Triangle implements IIntersectable{
    public static final double EPSILON = 0.0000001;
    private Vector3D[] vertices;
    private Vector3D[] normals;

    /*As it is below, we can see that it has 3 differents constructors, each one for a different object/situation*/
    ...
    /*
    * This function will rely on one of its two private variables, if it is null then it will obtain the value of the normal as a vector,
    * so that it is later saved in an array of vectors with the values ​​of the other normals*/
    ...
    /*This method will work with the previus method getNormals and will return a vector3D with the information/value of the normal
     calculated of every vector.*/
    ...
    /*Finally we have the function that has from the IIntersectable interface, which will basically retrieve the value of the distance*/
    @Override
